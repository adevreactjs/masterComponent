            ...
            <div className={cls.info}>
              ...
              <section className={cls.cartDescription}>
                <p>
                  ...
                  Оснащена сокетом 1700, підтримує швидкісну пам'ять та має широкий набір
                  інтерфейсів. Дозволяє встановлювати 128 ГБ оперативної пам'яті, використовуючи 4
                  слоти для планок. Призначена для процесорів Intel 13-го покоління. Завдяки системі
                  живлення, комплексним рішенням для охолодження та інтелектуальним параметрам
                  налаштування PRIME Z790-P WIFI D4 надає користувачам і розробникам ПК низку
                  оптимізацій продуктивності за допомогою інтуїтивно зрозумілих функцій програмного
                  забезпечення та прошивки. Материнська плата PRIME Z790-P WIFI D4 містить гнучкі
                  інструменти для налаштування кожного аспекту вашої системи, дозволяючи
                  налаштовувати продуктивність так, щоб вона ідеально відповідала вашому способу
                  роботи. ASUS Intelligent Control робить ваш...
                </p>
