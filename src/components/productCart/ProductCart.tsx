          ...
          <>
            <div className={cls.product}>
              <div className={cls.info}>
                <section className={cls.cartGallery}>
                  ...
                  <div className={cls.mainImage}>
                    <p className={cls.bonus}>+15 бонусів</p>
                ...
                <section className={cls.cartDescription}>
                  <p>
                    ...
                    <br />
                    <br />
                    Завдяки системі живлення, комплексним рішенням для охолодження та
                    інтелектуальним параметрам налаштування PRIME Z790-P WIFI D4 надає користувачам
                    розробникам ПК низку оптимізацій продуктивності за допомогою інтуїтивно
                    зрозумілих функцій програмного забезпечення та прошивки.
                    <br />
                    <br />
                    Материнська плата PRIME Z790-P WIFI D4 містить гнучкі інструменти для
                    налаштування кожного аспекту вашої системи, дозволяючи налаштовувати
                    продуктивність так, щоб вона ідеально відповідала вашому способу роботи. ASUS
                    Intelligent Control робить ваш...
                  </p>
              ...
              <section className={cls.price}>
                ...
                <div className={cls.ratingMobile}>
                  <p className={cls.inStockMobile}>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='7'
                      height='7'
