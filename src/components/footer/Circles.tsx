    ...
    <>
      <Link href={redirectionLink} target='_blank'>
        <div className='relative hover:cursor-pointer'>
          <div
            className={` flex justify-center items-center absolute top-0 right-0 w-full h-full ${styles.animSpin}`}>
          ...
          <div
            className={`${
              sizingCircle + sizingText
            } flex items-center justify-center bg-transparent relative z-[1]`}>
            <p>{text}</p>
          </div>
        </div>
      </Link>
