    ...
    return(
        <div className="mb-[10vw] mt-[5vw]">
            ...
            <div className="flex flex-row flex-wrap justify-center min-[280px]:gap-[15px] min-[920px]:gap-[2vw]">
                ...
                <BenefitsCard Num="4" Point="5 років довіри" Text="5 років роботи та більше 10000 відгуків, які допоможуть вам обрати потрібний продукт та покращити якісь нашої з покупцями взаємодії."/>
                <BenefitsCard Num="5" Point="Фізичні магазини" Text="Фізичні магазини надають можливість оглянути та випробувати товари перед покупкою, що створює додатковий рівень впевненості."/>
            </div>
        </div>
